...
const scenes = {
    part1: [
        ...
        { text: "Вы приподнялись на локтях. Прямо перед вами стояла Она.\nВысокая, статная, она уверенно держалась на лапах. Белая, как иней, грива, была столь густой, что обрамляла морду, придавая кошке шарма. Сама морда резкая, красивая в своей северной холодности. Глаза осматривали вас с долей обеспокоенности и волнения.", img: "img/purga_full.png" },
        ...
        { 
            ...
            choices: [
                ...
                { label: "Не знаю... всё болит.", reaction: "— Не знаю... — простонали вы, чувствуя каждый удар сердца. - Нет... вроде бы," }
            ]
        },

        { text: "Она смотрела слишком пристально и сидела слишком близко, без сомнений и всякой скромности вторгаясь в чужое личное пространство.\n— Вроде бы — это не ответ. Покажи шею. Лапы, — тон её сменился и стал более жестким. Не время было играть.", img: "img/purga_face.png" },
        { text: "Вы подчинились без пререканий. Северянка провела лапой по вашему меху быстро и уверенно, будто делала это сотни раз.\n— Чисто, — наконец выдохнула она и позволила себе слабую улыбку, — Значит, не зря я тебя нашла.", img: "img/purga_face.png" },
        ...
        { text: "Она ещё не знала, что вы заметили.\n— Вставай, — сказала Пурга, уже поднимаясь. — Нам нужно идти. Пока всё окончательно не рухнуло.", img: "img/purga_face.png" },
        
        { 
            text: "Она ждала.", 
            img: "img/purga_full.png",
            choices: [
                { label: "Ты... — вы осеклись. — У тебя на плече...", reaction: "— Ты… — вы осеклись. — У тебя на шее…" },
        ...
        { text: "— Я в курсе, — цокнула та, отмахнувшись жестом лапы, — Но пока ещё думаю ясно. А значит, у нас есть шанс. Если ты не тупица.", img: "img/purga_face.png" },
        
        { text: "Она пошла первой, не оглядываясь. Нагнать её вам ничего не стоило.\n— Есть убежище, — сказала та, когда вы углубились в лес. — Шаманки. Если успеем — меня вытащат. Если нет… — она пожала плечами.\nНесказанные слова повисли в воздухе, не нуждаясь в озвучке.", img: "img/purga_went.png", newBg: 'forest' },
        
        { text: "Вы хотели спросить, зачем ей ВЫ, но она опередила.", img: "img/purga_not_question.png" },

        { text: "— Мне нужен собеседник. И свидетель. А ещё… — она усмехнулась. — Мне скучно идти с котом, который не способен думать. Так что, если хочешь дожить — отвечай. И шевелись давай, — добавила та, ускоряя шаг.", img: "img/purga_smile.png" },
    ...
    part2: [
        { text: "Лес редел. Снег под ногами был тёмным. Через некоторое время её дыхание стало тяжелее. Она всё чаще касалась плеча. Рана на нем будто зудела, захватывая всё внимание, мешая мыслить ясно. Пурга стала раздражительнее, периодически рычала и бросала оскорбления в воздух, ни на кого конкретного не нацеленные.", img: "img/purga_went.png" },
    ...
    part3: [
        ...
        { text: "— Не вздумай меня жалеть, — прошипела она, оттолкнув вас. — Я не для этого тебя веду.", img: "img/purga_not_smile.png" },
        ...
        { text: "И вы послушались: ...", img: "img/purga_face_face.png", riddleId: 2 }
    ],
    ...
    bad_ending: [
        ...
        { text: "— Какая жалость, — хохотнула она, расплываясь в улыбке ещё шире, что казалось и вовсе невозможным. — Терпеть не могу бездарные умы. — хрипло прошипела та и вцепилась вам в шею. \nПоследнее, что вы увидели — белую гриву в крови и снег, медленно темнеющий под ней.", img: "img/purga_smile_danger2.png" }
    ],

    ending: [
        { text: "Вы всё ответили правильно. \nПурга улыбнулась — впервые искренне. Почти тепло.\n— Ну вот. Я знала, что ты не зря мне попался, — она почти по-дружески похлопала вас по плечу, поднявшись с земли и на этот раз даже позволив помочь ей дойти.", img: "img/purga_face_hill.png" },
        { text: "Вы успели. Шаманка выбежала вам навстречу, ругаясь и прижимая лапы к шее Пурги.\n— Жить будешь, — буркнула она.", img: "img/purga_face_hill.png" },
        { text: "Кошка, уже теряя сознание, шепнула:\n— Видишь? Интеллект — тоже оружие.", img: "img/purga_face_final.png" }
    ]
};
